...
<body>
 <div class="container">
      ...
      <label style="color:black">Enter date:</label><input type="date" name="alp" required="required" style="border-radius: 25px;"/><br/>
    ...
    <table class="table table-condensed" border="1px" width="100%">
      ...
      if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $query = mysql_query("Select * from products where doe < '$k' order by doe ");
