...
<body>
 <div class="container">
      ...
      <label style="color:black">Enter Starting Alphabate:</label><input type="text" name="alp" required="required" style="border-radius: 25px;color:black;"/><br/>
       </form>
    <table class="table table-condensed" border="1px" width="100%">
      ...
      if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $query = mysql_query("Select * from products where pro_name like '$k%' ");
