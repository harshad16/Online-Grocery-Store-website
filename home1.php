   ...
   <h1 class="text-uppercase  animated wow wobble" data-wow-delay="1s" style="font-size:24;font-family:Copperplate Gothic Light;color:black">Grocery Store</h1> 
      ...
      <nav class="pull-left">
        <ul class="list-unstyled">
          ...
          <li class="animated wow bounceInLeft" data-wow-delay="1.2s"><a href="empbill.php" style="color:red;"><button  style="font-size:24;font-family:Copperplate Gothic Light;color:red;border-radius:10px;">Go FOR BILLING</button></a></li>        
        </ul>
      </nav>
	...
	<div>
		 <a href="emplogout.php"><button  style="font-size:24;font-family:Copperplate Gothic Light;color: #FF6600;position:absolute;right:0px;">LOG-out</button></a>
...
{    while($row = mysql_fetch_assoc($query)) //display all rows from query
	...
	//	$_SESSION['user'] = $username; 
	   mysql_query("INSERT INTO cashier (cashier,pro_name,pro_id,cat_id,quan,price) values('$emp','$pro_name','$id','$cid','$q','$p')");
       
       Print '<script>alert("Item Added to CART");</script>'; //Prompts the user
		// header("location:index.php");
		Print '<script>window.location.assign("home1.php");</script>';
