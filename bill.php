...
<?php
 ...
 <div class="container">
      <div class="row text-center">
          ...
          <p><h3>Customer Name: <?php Print "$user"?></h3></p>
...
<a href="logout.php"> <button  style="font-size:24;font-family:Copperplate Gothic Light;color: #FF6600;position:fixed;bottom:0px;right:0px;">LOG-out</button></a
>    </div>
  </body>
</html>
